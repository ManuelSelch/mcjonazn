...
<div id="wrapper">
    ...
    <header id="banner" class="scrollto clearfix" data-enllax-ratio=".5">
                        ...
                        <ul class="social-icons">
                            ...
                            <li>
                                <a target="_blank" title="Spotify"
                                   href="https://open.spotify.com/artist/6FAEDYKPfsGIFp2T1fQbMk?si=bXTyWbhASmybenoGk15rMQ">
                                    <i class="fa fa-spotify fa-1x"></i><span>Spotify</span>
                                </a>
                            </li>
                            <li>
                                <a target="_blank" title="Apple Music"
                                   href="https://music.apple.com/de/artist/mcjonazn/1682264758">
        ...
        <div id="banner-content" class="row clearfix">
            ...
            <div class="col-38" style="background-color: rgba(255, 255, 255, 0.8);">
                ...
                <!--Call to Action-->
                <a target="_blank" href="https://music.imusician.pro/artist/IrdowlMI2e/releases" class="button">JETZT
                    STREAMEN 🎧</a>
                <!--End Call to Action-->
    ...
    <main id="content">
                        ...
                        <ul class="splide__list">
                            ...
                            foreach ($releases as $release) {
                                ...
                                <li class="splide__slide">
                                    <a onclick='openModal(<?php echo json_encode($release); ?>, <?php echo json_encode($services); ?>)'
                                       id="modal-closed">
            ...
            <div class="modal">
                ...
                <div style="display: flex; justify-content: center;">
                    <a target="_blank" class="modal__btn" href="" id="tidal">
                        <svg class="css-1vp3f8h e13waqcv0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 104 24">
                            <path d="m80.9 18-1-2.7h-5L73.6 18h-2.6l5-12h2.5l5 12H81ZM77.3 9 75.7 13H79L77.3 9ZM32 8.5V6.1h9.8v2.4h-3.6V18h-2.6V8.5H32ZM9 6.1l-3 3 3 3 3-3 2.9 3-3 3 3 2.9 3-3-3-3 3-3-3-2.9-3 3-3-3Zm8.9 3 3 3 3-3-3-3-3 3Zm32-3h-2.6V18H50V6ZM56.3 18h4.6c3.7 0 6.3-2.6 6.3-6 0-3.3-2.6-6-6.3-6h-4.6v12Zm4.6-9.6c2.1 0 3.6 1.5 3.6 3.6s-1.5 3.6-3.6 3.6h-2V8.4h2Zm28-2.3V18h8.5v-2.4h-6V6h-2.6Z"></path>
                        </svg>
                    </a>
                </div>
        ...
        <!--Playlists-->
        <aside id="playlists" class="scrollto row clearfix text-center" data-enllax-ratio=".3">

            <div class="row clearfix">

                <div class="section-heading">
                    <h3>Playlists</h3>
                    <h2 class="section-title">Enthalten in</h2>
                </div>
